...
const ENTRA_CONTROLS = [
  ...
  { name: 'Legacy authentication blocked', desc: 'Legacy authentication is blocked through Conditional Access policies', severity: 'critical', weight: 2, automatable: true, category: 'Authentication & MFA' },
  { name: 'Microsoft Authenticator enabled', desc: 'Microsoft Authenticator is enabled for applicable users', severity: 'high', weight: 1, automatable: true, category: 'Authentication & MFA' },
  ...
  { name: 'Temporary Access Pass enabled', desc: 'Temporary Access Pass (TAP) is enabled', severity: 'low', weight: 1, automatable: true, category: 'Authentication & MFA' },
  { name: 'SMS Authentication disabled', desc: 'SMS authentication is disabled for applicable users', severity: 'high', weight: 1, automatable: true, category: 'Authentication & MFA' },
  { name: 'Voice Call Authentication disabled', desc: 'Voice call authentication is disabled for applicable users', severity: 'high', weight: 1, automatable: true, category: 'Authentication & MFA' },
  ...
  { name: 'Password Protection Smart Lockout configured', desc: 'Password protection smart lockout is configured', severity: 'high', weight: 1, automatable: true, category: 'Authentication & MFA' },

  // ==================== CONDITIONAL ACCESS (9 controls) ====================
  { name: 'Conditional Access policies configured', desc: 'Conditional Access policies are configured', severity: 'critical', weight: 2, automatable: true, category: 'Conditional Access' },
  { name: 'Conditional Access requires MFA for administrators', desc: 'Conditional Access requires MFA for administrators', severity: 'high', weight: 2, automatable: true, category: 'Conditional Access' },
  ...
  { name: 'Token Protection enabled', desc: 'Token protection is enabled for supported workloads', severity: 'high', weight: 1, automatable: true, category: 'Conditional Access' },

  // ==================== PRIVILEGED IDENTITY MANAGEMENT (3 controls) ====================
  { name: 'PIM enabled', desc: 'Privileged Identity Management (PIM) is enabled', severity: 'critical', weight: 2, automatable: true, category: 'Privileged Identity Management' },
  ...
  { name: 'PIM activation requires MFA', desc: 'PIM activation requires MFA', severity: 'high', weight: 2, automatable: true, category: 'Privileged Identity Management' },

  // ==================== PRIVILEGED ACCESS & ADMINISTRATION (1 control) ====================
  { name: 'Global Administrator count within limit', desc: 'Global Administrator accounts are not more than 5', severity: 'high', weight: 2, automatable: true, category: 'Privileged Access & Administration' },

  // ==================== ACCESS CONTROLS & REVIEW (5 controls) ====================
  { name: 'Access Review for guest users configured', desc: 'At least one Access Review is configured for guest users', severity: 'critical', weight: 1, automatable: true, category: 'Access Controls & Review' },
  ...
  { name: 'Access Reviews have reminder notifications', desc: 'At least one Access Review has reminder notifications enabled', severity: 'critical', weight: 1, automatable: true, category: 'Access Controls & Review' },
  ...
  { name: 'Sign-in logs available', desc: 'Sign-in logs are available for the tenant', severity: 'high', weight: 1, automatable: true, category: 'Identity Monitoring & Logging' },
  { name: 'Directory audit logs available', desc: 'Directory audit logs are available for the tenant', severity: 'high', weight: 1, automatable: true, category: 'Identity Monitoring & Logging' },
  { name: 'Provisioning logs available', desc: 'Provisioning logs are available for the tenant', severity: 'medium', weight: 1, automatable: true, category: 'Identity Monitoring & Logging' },
